...
const Item = ({ image, title, star, address, description, attributes, sellers, id }) => {
  ...
  return (
    <div className="row p-4 border-solid border-t-2 border-red-500 ms-0 me-0 bg-[#fff9f3] md:flex-col md:gap-7">
      <Link
        to={`/${configRouter.detail}/${formatVietnameseToString(title.replaceAll("/", ""))}/${id}`}
        className="relative col-lg-5 col-md-12  d-flex flex-wrap h-[266px]">
